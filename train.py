...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Simple example of a stable diffusion training script."
    )
    # TODO: Add args
    # utils
    parser.add_argument("--logging_dir", type=str, default="logs", help="log directory")
    parser.add_argument(
        "--tracker",
        type=str,
        default=None,
    ...
    # loading and saving
    parser.add_argument("--tokenizer", type=str, default="openai/clip-vit-base-patch16")
    parser.add_argument(
        "--text_encoder",
        type=str,
...
class StableDiffusion:
    ...
    def __save_model(self):
        self.noise_scheduler.save_pretrained("ckpt/scheduler")
        self.unet.save_pretrained("ckpt/unet")
        self.text_encoder.save_pretrained("ckpt/text_encoder")
        self.autoencoder.save_pretrained("ckpt/autoencoder")
    ...
    def prepare(self, args):
        ...
        self.autoencoder.to(self.accelerator.device, dtype=self.weight_dtype)
